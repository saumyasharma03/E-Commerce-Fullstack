...
export default function Footer() {
  return (
    <footer className="relative w-full bg-gray-900">
      <div className="mx-auto w-full max-w-7xl px-8 pt-20 mt-20">
            ...
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <Typography
                  variant="small"
                  color="blue-gray"
                  className="mb-3 font-medium opacity-40 text-white"
                >
                  {title}
                </Typography>
                {items.map((link) => (
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear}{" "}
            <a href="https://material-tailwind.com/" className="text-white">
              PetBUDDY
            </a>
            . All Rights Reserved.
          </Typography>
