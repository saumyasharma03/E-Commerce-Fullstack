...
const CartItems = () => {
    const { all_products, cartItems, remvoeFromCart, getTotalCartAmount } = useContext(ShopContext);
    ...
    return (
        <section className='max_padd-container pt-28'>
                            ...
                            return <tr key={e.id} className='border=b border-slate-900/20 text-gray-30 p-6 medium-14 text-center'>
                                ...
                                <td>
                                    <div className='bold-22 pl-14'>
                                        <TbTrash onClick={() => remvoeFromCart(e.id)} />
                                    </div>
                                </td>
                            </tr>
                        }
            ...
            <div className='w-full  flex flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white'>
